...
export const Dropdown = () => {
  ...
  return (
    <div className="relative inline-block w-full">
      <button
        type="button"
        className="inline-flex w-full items-center justify-center gap-2.5 rounded-md bg-primary px-4 py-3 font-medium text-white hover:bg-opacity-95"
        onClick={() => handleOpen()}
      >
        Category
        <svg
        ...
        <div className="absolute left-0 top-full z-40 mt-2 w-full rounded-md border border-stroke bg-white py-3 shadow-card dark:border-strokedark dark:bg-boxdark">
          <ul className="flex flex-col">
            <li>
              <a
                href="#"
                className="flex px-5 py-2 font-medium hover:bg-whiter hover:text-primary dark:hover:bg-meta-4"
              >
                Dashboard
              </a>
            </li>
