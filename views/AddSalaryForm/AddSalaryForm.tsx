...
import { createSalary } from '@/app/lib/api-client/salary';
import {
  generateMonthMap,
  generateYearMap,
  getCurrentMonth,
...
export const AddSalaryForm = () => {
  const { currentMonthName, currentYear } = getCurrentMonth();
  ...
  const onSubmit = (salary: FormProps) => {
    setIsFormLoading(true);
    try {
      const response = createSalary(salary);
      if (response) {
                ...
                >
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select
                      ...
                      {...register('month')}
                    >
                      <option value="">Type month</option>
