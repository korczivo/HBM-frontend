              ...
              <form action="#">
                ...
                >
                  <input
                    type="file"
                    accept="image/*"
                    className="size-full absolute inset-0 z-50 m-0 cursor-pointer p-0 opacity-0 outline-none"
                  />
                  <div className="flex flex-col items-center justify-center space-y-3">
                    <span className="size-10 flex items-center justify-center rounded-full border border-stroke bg-white dark:border-strokedark dark:bg-boxdark">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
